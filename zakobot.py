...
@bot.slash_command(name='parse_roleta')
async def parse_roleta_command(
    ctx: discord.ApplicationContext,
    idx: discord.Option(str, name='index'),
    giver: discord.Option(str, name='giver'),
    receiver: discord.Option(str, name='receiver'),
    roleta: discord.Option(int, name='roleta'),
    recs: discord.Option(str, name='recs'),
    score: discord.Option(int, name='score'),
